...
abstract class YunxinResponse
{
     ...
     *
     * @return mixed
     * @throws YunxinException() cant deserialize response
     */
    public function deserialize($to_array = false)
    {
        $decoded = json_decode($this->body, (bool)$to_array);
        if (!$decoded) {
            throw new YunxinException("Unable to deserialize response");
        }
        return $decoded;
    }
    ...
    {
        return $this instanceof SuccessYunxinResponse;
    }
    ...
    {
        return $this instanceof FailureYunxinResponse;
    }
}
